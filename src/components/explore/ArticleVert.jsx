      ...
      >
        <CardActionArea>
          <CardMedia
            component="img"
            height="250"
            image="https://picsum.photos/810/250"
            alt="lorem picsum"
          />
          <CardContent style={{ padding: '20px 15px' }}>
            <Typography
      ...
      >
        <CardActionArea>
          <CardMedia
            component="img"
            height="250"
            image="https://picsum.photos/804/250"
            alt="lorem picsum"
          />
          <CardContent style={{ padding: '20px 15px' }}>
            <Typography
            ...
            <Typography variant="body1" color="text.secondary">
              It was the first Arab state to make peace with Israel back in 1978
              - after fighting several wars with the Jewish state. Now, the
              focus is on Egypt's control of one of the two land routes out of
              the Gaza..
            </Typography>
          </CardContent>
        </CardActionArea>
